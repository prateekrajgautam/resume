...
%
%
\input{./includes/part/NameAndAddress}
\begin{document}
\begin{resume}
%\vspace{-1em}
\fullline
...
\vspace{-1em}
\sectionline
\input{./includes/part/Work}
\input{./includes/part/Edu}
%\input{./includes/part/EduShort}
\input{./includes/part/ResearchInterest}
\input{./includes/part/ComputerSkills}
\input{./includes/part/Publications}
\input{./includes/part/Achievements}
\input{./includes/part/Reviewer}
\input{./includes/part/Workshops}
\input{./includes/part/Interests}
\input{./includes/part/References}
\input{./includes/part/PersonalProfile}
\input{./includes/part/Declaration}
\end{resume}
\nocite{*}
%\printbibliography
\end{document}
